...
const stakeManageABI = `[
    ...
    },
    {
      ...
      "name": "getValidatorShareContractFromSigner",
      "outputs": [
        {
          "internalType": "address",
          "name": "",
    ...
    },
    {
      ...
      "name": "minimalValidatorListIndex",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
		...
		"outputs": [
			{
				...
				"internalType": "struct StakeManagerStorage.MinimalValidator[]",
				"name": "",
				"type": "tuple[]"
			}
		],
