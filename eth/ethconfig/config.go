...
func CreateConsensusEngine(config *params.ChainConfig, db ethdb.Database, backend ethapi.Backend, blockchainAPI *ethapi.BlockChainAPI) (consensus.Engine, error) {
	// If proof-of-authority is requested, set it up
	if config.Clique != nil {
		// create contract client and use with clique
		client, err := contract.New(config, blockchainAPI)
		if err != nil {
			panic(err)
		}
